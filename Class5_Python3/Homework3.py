...
for score_dict in new_score_list:
    score_text = "Player", score_dict["player_name"], "had", str(score_dict["attempts"]), "attempts on", score_dict[
        "date"], ". The secret number was", score_dict["secret_number"], ". The wrong guesses were:", score_dict[
                     "wrong_guesses"]
    print(score_text)
